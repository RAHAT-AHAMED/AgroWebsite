...
<div class="page-content">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="card-container" style="margin-left: 350px;">
               <div class="front">
                  <div class="image">
                     <img src="{{ asset('uploads/chip.png') }}" alt="">
            ...
            <form style="margin-left:260px;" action="{{ route('donate_submit') }}" method="post">
                @csrf
               <div class="inputBox">
               ...
               <div class="flexbox">
                  ...
                  <div class="inputBox">
                    ...
                    <div class="inputBox">
                        <span>Amount</span>
                        <input name="amount" type="text" class="card-holder-input">
                    </div>
               </div>
